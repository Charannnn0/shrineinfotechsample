      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <Link 
              to="/" 
              className={`transition-all duration-300 ${isScrolled ? 'text-muted-foreground/70 hover:text-muted-foreground text-sm' : 'text-foreground hover:text-primary'}`}
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            >
              Home
            </Link>
            <a href="#about" className={`transition-all duration-300 ${isScrolled ? 'text-muted-foreground/70 hover:text-muted-foreground text-sm' : 'text-foreground hover:text-primary'}`}>
              About Us
            </a>
            ...
            <div className="relative">
              <button 
                ...
                className={`flex items-center transition-all duration-300 focus:outline-none ${isScrolled ? 'text-muted-foreground/70 hover:text-muted-foreground focus:text-muted-foreground text-sm' : 'text-foreground hover:text-primary focus:text-primary'}`}
            ...
            {/* Other Services */}
            <a href="#other-services" className={`transition-all duration-300 ${isScrolled ? 'text-muted-foreground/70 hover:text-muted-foreground text-sm' : 'text-foreground hover:text-primary'}`}>
              Other Services
            </a>
