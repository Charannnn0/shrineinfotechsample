...
const About = () => {
  const stats = [
    ...
    { icon: Users, value: "200+", label: "ERP Implementations" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800">
                About <span className="text-orange-500">Shrine InfoTech</span>
              </h2>
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat) => (
              <div 
                key={stat.label}
                className="bg-gradient-to-br from-blue-50 to-orange-50 p-6 rounded-2xl text-center shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-600 to-orange-500 rounded-xl mb-4">
